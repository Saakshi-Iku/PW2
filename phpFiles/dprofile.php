...
$con=getCon();
	...
	$sqlread="SELECT * FROM driver_details";
...
<body>
	...
	<div class="jumbotron">
		<div id="outer-circle">
		  <div id="inner-circle">
		  	<img id="im" src="./css/driver1.jpg" />
		  </div>
		</div>

		<div class="d-flex flex-column justify-content-center">
			<h4 class="name" style="text-align:center"><?php echo $row['FIRSTNAME']?>
				<?php echo $row['LASTNAME']?></h4>
			<h6 class="coll" style="text-align:center">DRIVER</h6>
			<div class="val1">
				<h5>
			...
			<div class="val2">
				<h5>
					<span style="margin-right: 35px"><i class="fa fa-car" aria-hidden="true"></i></span>
					KA-1234
				</h5>
			</div>
